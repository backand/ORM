            ...
            if (!error && response.statusCode == 200) {
                ...
                async.map(body.fields,
                    function (item, callback) {
                        if (!withIdColumn && (item.name == "id" || item.name == "Id")) {
                            ...
                            if (item.type == "MultiSelect") {
                                ...
                                description = _.extend(_.omit(description, "type", "relatedViewName", "relatedParentFieldName"), {
                    ...
                    function (err, results) {
                        var results = _.filter(results, function (r) {
                            return r;
                        });
                        var fields = _.object(_.pluck(results, "name"), _.map(results, function (c) {
